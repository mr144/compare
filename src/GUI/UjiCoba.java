...
//====== Normalisasi Skor CSF ==================================================
        Map<String, Double> norm1 = null, norm2 = null;
        proc.alpha = 0.0;
        for (int i = 0; i <= 10; i++) {
            norm1 = proc.normalisasi(katgsfcsf1);
            norm2 = proc.normalisasi(katgsfcsf2);
            proc.alpha = proc.alpha + 0.1;
...
////======Tampilkan Hasil Perbandingan Skor Rekomendasi===========================
    ...
    public void Uji(int t) throws IOException, WriteException {
        ...
        // <PRODUK phone> //
//            String produk1[] = {"Motorola Atrix MB860", "HTC Inspire", "Nokia Lumia 710", "Google Nexus", "Apple Iphone 3GS", "Blackberry Torch 9380", "Sony Xperia U.", "Blackberry Curve 9360", "LG Optimus L7",  "Samsung Galaxy Ace Plus"};
//            String produk2[] = {"Motorola Atrix MB860", "HTC Inspire", "Nokia Lumia 710", "Google Nexus", "Apple Iphone 3GS", "Blackberry Torch 9380", "Sony Xperia U.", "Blackberry Curve 9360", "LG Optimus L7",  "Samsung Galaxy Ace Plus"};
...
//                }
//            }
//        RunDataCSF("Google Nexus", "Apple Iphone 3GS");
//        RunDataCSF("Google Nexus", "Blackberry Curve 9360");
    }
